...
function DropdownMenuSubTrigger({
	...
	return (
		<MenuPrimitive.SubmenuTrigger
			...
			data-inset={inset}
			className={cn(
				"flex cursor-default items-center gap-2 rounded-lg px-2.5 py-2.5 text-sm font-medium outline-hidden select-none focus:bg-primary/8 focus:text-primary data-inset:pl-8 data-popup-open:bg-primary/8 data-popup-open:text-primary data-open:bg-primary/8 data-open:text-primary [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
				className,
			)}
			{...props}
		>
...
function DropdownMenuCheckboxItem({
	...
	return (
		<MenuPrimitive.CheckboxItem
			...
			data-inset={inset}
			className={cn(
				"relative flex cursor-default items-center gap-2 rounded-lg py-2.5 pr-8 pl-2.5 text-sm font-medium outline-hidden select-none focus:bg-primary/8 focus:text-primary focus:**:text-primary data-inset:pl-8 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
				className,
			)}
			checked={checked}
			{...props}
