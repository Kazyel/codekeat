...
const alertVariants = cva(
	"group/alert relative grid w-full gap-1 rounded-xl border-2 border-foreground px-4 py-3.5 text-left text-sm shadow-[4px_4px_0_var(--hard-shadow)] has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pr-20 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2.5 *:[svg]:row-span-2 *:[svg]:translate-y-0.5 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4",
	{
		variants: {
			variant: {
